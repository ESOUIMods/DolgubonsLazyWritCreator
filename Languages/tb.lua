...
--
-- File Name: Languages/tb.lua
-- File Description: Turkish Localization (Translation Mode)
...
function WritCreater.langCraftKernels()
	return
	{
		...
		[CRAFTING_TYPE_BLACKSMITHING] = "Demirci", -- 146361138-0-528
		[CRAFTING_TYPE_CLOTHIER] = "Kıyafetçi", -- 146361138-0-832
		[CRAFTING_TYPE_PROVISIONING] = "Sağlayıcı", -- 68561141-0-180
		[CRAFTING_TYPE_WOODWORKING] = "Ağaç işleri", -- 260523861-5-24
		[CRAFTING_TYPE_ALCHEMY] = "Alchemia",
		[CRAFTING_TYPE_JEWELRYCRAFTING] = "Biżuteria",
	}
end
...
function WritCreater.langMasterWritNames() -- Note for translations: Skip this, unless you reaaaaally want to make master writs work, which I do not recommend
	...
	[CRAFTING_TYPE_ENCHANTING]		= "glif",
	[CRAFTING_TYPE_PROVISIONING]	= "uczta",
	["plate"]						= "pancerz",
